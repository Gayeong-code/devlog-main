...
const siteConfig = {
  username: "Gayeong", // GitHub 사용자 이름
  repositoryName: "https://gayeong-code.github.io/devlog-main/", // GitHub 저장소 이름
  mainColor: "#3498db", // 사이트의 주 색상
  textColor: "#333333", // 기본 텍스트 색상
  blogTitle: "Gayeong's DevLog", // 블로그 제목
};
